	...
	<div class="layout">
		<div class="nl-content">
			...
			<h1 class="nl-login-title" id="custom_display_256">
				<span id="message_LOGIN_TITLE">小熊微信商城登录</span>
			</h1>
			...
			<div id="custom_display_2">
				<p class="nl-login-intro" id="message_LOGIN_LINKS">
					<a href="http://www.xiaomi.com/" target="_blank">小熊手机</a>，<a
						href="http://www.xiaomi.com/index.php" target="_blank">小熊网</a>，<a
						href="http://www.miui.com/" target="_blank">MIUI米柚</a>，<a
						href="http://www.duokan.com/" target="_blank">多看阅读</a>，<a
						href="http://www.miliao.com/" target="_blank">熊聊</a>
				</p>
			</div>
						...
						<div class="shake-area" id="shake_area" style="z-index: 30;">
							...
							<div class="enter-area" id="enter_user">
								<input type="text" name="userName"
									...
									placeholder="邮箱/手机号码/小熊商城帐号"> <i
									class="placeholder hide" id="message_INPUT_IDENTITY">用户名</i> <span
